...
export const usersAPI = {
  getSalesAdmins: () => api.get('/users/sales-admins'),
  createSalesAdmin: (data: any) => api.post('/users/sales-admins', data),
  updateSalesAdmin: (id: string, data: any) => api.put(`/users/sales-admins/${id}`, data),
  deleteSalesAdmin: (id: string) => api.delete(`/users/sales-admins/${id}`),
  
  getSalesPersons: () => api.get('/users/sales-persons'),
  createSalesPerson: (data: any) => api.post('/users/sales-persons', data),
  updateSalesPerson: (id: string, data: any) => api.put(`/users/sales-persons/${id}`, data),
  deleteSalesPerson: (id: string) => api.delete(`/users/sales-persons/${id}`),
};
